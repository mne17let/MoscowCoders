...
import com.sportrgu.data.RepositoryImplementation
import com.sportrgu.data.models.people.Booking
import com.sportrgu.data.models.sport_objects.SportObjectModel
import com.sportrgu.data.models.sport_objects.ui_format.UiDay
import com.sportrgu.data.models.sport_objects.ui_format.UiPeriod
import com.sportrgu.fragment_sport_objects_list.helpers.DaysSortHelper
    ...
    private fun setCheckInButton(){
        check_in_button.setOnClickListener {
            ...
            if (currentStringChoice != null){
                ...
                RepositoryImplementation().sendBooking(
                    Booking(
