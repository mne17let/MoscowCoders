package com.sportrgu.fragment_write_profile.ui
...
import com.sportrgu.fragment_write_profile.helpers.SendProfileDataHelper_FB
import com.sportrgu.fragment_write_profile.helpers.ProfileValidationHelper
    ...
    private fun setSendProfileButton(){
        buttonSendProfile.setOnClickListener {
            ...
            if(currentUser != null){
                ...
                val newStudentModel = StudentModel(email, fName, lName, gender, studyGroup, studyYear, faculty)
